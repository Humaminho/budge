...
export const benefits: IBenefit[] = [
	...
	},
	{
		...
		description:
			'Start building wealth today, no financial degree required. Budge makes investing accessible and straightforward.',
		bullets: [
			{
				title: 'Micro-Investing',
				description:
					'Begin with as little as $1 and watch your money grow.',
	...
	},
	{
		...
		description:
			'Your financial data deserves the best protection. Rest easy knowing Budge employs cutting-edge security measures.',
		bullets: [
			{
