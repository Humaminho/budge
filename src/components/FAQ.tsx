	...
	return (
		<section id="faq" className="py-10 lg:py-20">
			<div className="flex flex-col lg:flex-row gap-10">
				<div className="">
					<p className="hidden lg:block text-foreground-accent">
						FAQ&apos;S
					</p>
					<SectionTitle>
					...
					<a
						href="mailto:"
						className="mt-3 block text-xl lg:text-4xl text-blue-600 font-semibold hover:underline text-center lg:text-left"
					>
									...
									<>
										<DisclosureButton className="flex items-center justify-between w-full px-4 pt-7 text-lg text-left border-t">
											...
											{open ? (
												...
												<BiPlus className="w-5 h-5 text-blue-600" />
											)}
										</DisclosureButton>
